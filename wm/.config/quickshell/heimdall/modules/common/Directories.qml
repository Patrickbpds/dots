...
Singleton {
    ...
    property string shellConfig: FileUtils.trimFileProtocol(`${Directories.config}/heimdall`)
    ...
    property string screenshotDir: FileUtils.trimFileProtocol(`${Directories.pictures}/Screenshots`)
